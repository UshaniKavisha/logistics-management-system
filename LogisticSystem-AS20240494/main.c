...
void loadDeliveries()
{
    ...
    while(fscanf(filePointer,"%d,%d,%f,%d,%f,%f,%f,%f,%f,%f\n",
                 ...
                 &deliveries[deliveryCount].deliveryCost,
...
void saveDeliveries()
{
    ...
    for(int i=0;i<deliveryCount;i++)
    {
        fprintf(filePointer,"%d,%d,%.2f,%d,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f\n",
